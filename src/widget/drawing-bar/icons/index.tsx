...
import regressionSegment from './regressionSegment'
...
export function createMoreLineOptions(locale: string): SelectDataSourceItem[] {
  return [
    ...
    { key: 'parallelChannel', text: i18n('parallel_channel', locale) },
    { key: 'volumeProfile', text: i18n('volume_profile', locale) },
    { key: 'regressionSegment', text: i18n('regression_channel', locale) },
...
export function createFibonacciOptions(locale: string): SelectDataSourceItem[] {
  return [
    { key: 'fibRetracement', text: i18n('fib_retracement', locale) },
...
export function createWaveOptions(locale: string): SelectDataSourceItem[] {
  return [
    ...
    { key: 'elliotWave', text: i18n('elliot_wave', locale) }
  ]
}

export function createRiskOptions(locale: string): SelectDataSourceItem[] {
  return [
...
style = "display: flex; align-items: center; justify-content: center; width: 32px; height: 32px; border-radius: 2px; transition: all 0.2s; cursor: pointer;" >
  { mapping[props.name]() }
  </div>
)
